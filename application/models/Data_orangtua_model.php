...
class Data_orangtua_model extends CI_Model
{

    public $table = 'data_orangtua';
    public $id = 'id_orangtua';
    public $order = 'DESC';
...
/* End of file Data_orangtua_model.php */
/* Location: ./application/models/Data_orangtua_model.php */
