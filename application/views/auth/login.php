                ...
                <div class="p-5">
                  ...
                  <form class="user" action="<?php echo base_url();?>Auth/proses_login" method="post">
                    <div class="form-group">
                      <input type="email" name="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukan Alamat Email...">
                    </div>
                    <div class="form-group">
                 ...
                 <!--  <div class="text-center">
                  ...
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url();?>auth/register">Belum Punya Akun ? Daftar Baru</a>
                  </div>
                </div>
              </div>
            </div>
